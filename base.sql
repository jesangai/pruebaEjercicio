...
ALTER TABLE ONLY public.mascotas
    ADD CONSTRAINT fk_mascostas_alumnos FOREIGN KEY (idalumno) REFERENCES public.alumnos(id);
...
INSERT INTO mascotas (nombre,foto,edad,idalumno) VALUES ('rayito','..\/excursiones\/pl1.jpeg','11',1);